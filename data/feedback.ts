export const Feedbacks = {
    listening: {
        part1: {
            ...
            6: {
                feedback:
                    "You’re performing well, but there are still some occasional missed details.",
                suggestions: [
        ...
        part2: {
            ...
            8: {
                feedback:
                    "You’re doing great and only missing occasional minor details.",
                suggestions: [
        ...
        part4: {
            0: {
                feedback:
                    "You’re struggling with understanding complex academic language and ideas.",
                suggestions: [
            ...
            2: {
                feedback:
                    "You’re missing key points but can sometimes follow the main argument.",
                suggestions: [
            ...
            4: {
                feedback:
                    "You’re following the main argument but may miss supporting details or examples.",
                suggestions: [
            ...
            6: {
                feedback:
                    "You’re doing well, but you might miss occasional details or secondary examples.",
                suggestions: [
            ...
            8: {
                feedback:
                    "You’re handling academic listening very well, missing only very fine points.",
                suggestions: [
    ...
    reading: {
        ...
        passage2: {
            ...
            9: {
                feedback:
                    "You’re performing well, but might miss very subtle opinions or indirect ideas.",
                suggestions: [
            ...
            11: {
                feedback:
                    "Excellent work! You’re almost perfect in this passage.",
                suggestions: [
        ...
        passage3: {
            0: {
                feedback:
                    "You’re struggling to understand the passage’s complex ideas and vocabulary.",
                suggestions: [
            ...
            11: {
                feedback:
                    "Excellent performance! You’ve mastered this passage.",
                suggestions: [
